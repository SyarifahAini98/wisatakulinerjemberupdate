...
<?php
	$query=mysql_query("SELECT * FROM berita where kategori='resep'")or die('perintah sql salah');
	$sql = "SELECT count(*) AS jumlah FROM berita where kategori='resep'";
	...
	echo'<tr><td><center>Tidak ada data!</center></td></tr>';
		...
		$query="select judul,gambar,isi,id_berita from berita where kategori='resep' order by id_berita limit $start, $per_page";

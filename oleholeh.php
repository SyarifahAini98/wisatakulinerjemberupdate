...
<?php
	...
	$query="select id_berita,judul,tgl_buat,tgl_update,gambar,isi,kategori,kunjungan from berita where kategori='oleholeh' order by kunjungan DESC limit $start, $per_page";
